 ...
 */
require_once('./stellantisOrder/readOrderFile.php');
...
function addOrder($id_order,$par_qui,$orderBuyer,$countryName,$countryCode,$partNumber,$codePochette,$quantity,$deliveredDate,$wip,$lien_couv,$family,$week,$year,$shortTerm,$model)
{
	...
	$_sql = "SELECT * FROM orders WHERE deliveredDate='".$deliveredDate."' AND family='".$family."' 
...
if(isset($filename)){
	...
	$data['result'] .= "<div id='long-term' style='margin-right:-10%;margin-left:-10%;padding:10px;background-color:#FFF;border:solid 1px;border-radius:5px;height:90vh;width:120%;overflow-x: auto;overflow-y: auto;white-space: nowrap;'>";
